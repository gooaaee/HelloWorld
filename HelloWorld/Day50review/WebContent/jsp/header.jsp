...
<div class="container-fluid">
	...
	<div class="col-md-3" style="padding-top:20px">
		<ol class="list-inline">
			<li><a href="#">欢迎用户${loginUser.name}</a></li>
...
<script>
$(function(){
	$.post("${pageContext.request.contextPath}/CategoryServlet",{},function(data){
		$("#myUL").html("");
		$.each(data,function(i,obj){
			var li = "<li ><a href='${pageContext.request.contextPath}/ProductServlet?method=getProductListByCidWithPage&num=1&cid=" + obj.cid + "'>"+
			obj.cname+"</a></li>";
			$("#myUL").append(li);
		});
		},"json");
